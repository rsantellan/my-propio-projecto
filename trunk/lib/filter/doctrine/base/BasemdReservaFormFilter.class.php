...
abstract class BasemdReservaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'status'            => new sfWidgetFormChoice(array('choices' => array('' => '', 'pending' => 'pending', 'confirm' => 'confirm', 'efective' => 'efective', 'cancel' => 'cancel', 'cancelPayPal' => 'cancelPayPal', 'errorPayPal' => 'errorPayPal', 'prePayPal' => 'prePayPal'))),
    ...
    $this->setValidators(array(
      ...
      'status'            => new sfValidatorChoice(array('required' => false, 'choices' => array('pending' => 'pending', 'confirm' => 'confirm', 'efective' => 'efective', 'cancel' => 'cancel', 'cancelPayPal' => 'cancelPayPal', 'errorPayPal' => 'errorPayPal', 'prePayPal' => 'prePayPal'))),
