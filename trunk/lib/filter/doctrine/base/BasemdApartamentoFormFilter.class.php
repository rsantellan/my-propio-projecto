...
abstract class BasemdApartamentoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'precio_febrero'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'precio_revellion'  => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'precio_febrero'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'precio_revellion'  => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'precio_media'      => 'Number',
      'precio_baja'       => 'Number',
      'precio_febrero'    => 'Number',
      'precio_revellion'  => 'Number',
