...
<div class="title">
    ...
    <li>/</li>
    <li class="current"><?php echo __('AcercaDe_navegacion') ?></li>
</div> 
<?php echo include_component('locaciones','title_right'); ?>
<div class="main-content-up">
  <div class="titulo green"><?php echo __('AcercaDe_Titulo') ?></div>
  <div class="texto">
		<?php echo simple_format_text(__('AcercaDe_Texto')) ?>
	</div>
</div>