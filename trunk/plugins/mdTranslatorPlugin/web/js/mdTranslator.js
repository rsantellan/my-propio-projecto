...
mdTranslator.prototype = {
    ...
    save: function(source, translation,id, selected_catalogue){
        var url = __MD_CONTROLLER_BACKEND_SYMFONY + '/mdTranslator/changeTextAjax';
    ...
    loadTexts: function(page){
        url = __MD_CONTROLLER_BACKEND_SYMFONY + '/mdTranslator/getTranslationsFormsAjax';
        mdShowLoading();
        $.ajax({
            url: url,
    ...
    changePages: function(){
        ...
        mdShowLoading();
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdTranslator/getApplicationPagesAjax',
            type: 'post',
    ...
    changeLenguage: function(){
        mdShowLoading();
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdTranslator/getLangsAjax',
    ...
    publish: function(){
        ...
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdTranslator/clearCache',
            type: 'post',
            dataType: 'json',
            success: function(json){
