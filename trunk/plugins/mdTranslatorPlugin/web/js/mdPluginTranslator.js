...
mdPluginTranslator.prototype = {
    ...
    save: function(source, translation,id, selected_catalogue){
        var url = __MD_CONTROLLER_BACKEND_SYMFONY + '/mdPluginTranslator/changeTextAjax';
    ...
    loadTexts: function(page){
        url = __MD_CONTROLLER_BACKEND_SYMFONY + '/mdPluginTranslator/getTranslationsFormsAjax';
    ...
    changePages: function(){
        var self = this;
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdPluginTranslator/getApplicationPagesAjax',
            type: 'post',
    ...
    changeLenguage: function(){
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdPluginTranslator/getLangsAjax',
    ...
    publish: function(){
        $.ajax({
            url: __MD_CONTROLLER_BACKEND_SYMFONY + '/mdPluginTranslator/clearCache',
            type: 'post',
            dataType: 'json',
            success: function(json){
                $('#show_publish').hide();
