var __MD_CONTROLLER_BACKEND_SYMFONY = '';
...
MdAvatarAdmin.prototype = {
    ...
    {
        var self = this;
		if(obj_name == 'mdUserProfile')
		{
			$.ajax({
				url: __MD_CONTROLLER_BACKEND_SYMFONY + '/perfil/retrieveUserAvatar',
				data: {'id': obj_id },
				dataType: 'json',
				type: 'post',
				success: function(response){
					...
					{
						$("#user_avatar_image").attr('src', response.options.src);
					}
