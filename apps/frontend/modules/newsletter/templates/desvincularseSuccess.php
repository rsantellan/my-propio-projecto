...
<div class="main-content-up">
  ...
  <div class="col-left">
    ...
    <?php if ($sf_user->hasFlash('ok')): ?>
      <h3><?php echo __('novedades_te has desregistrado'); ?></h3>
    <?php endif; ?>
    <form name="<?php echo $form->getName(); ?>" class="form-send" method="POST" action="<?php echo url_for('@newsletterDesvincularse') ?>">
      <?php echo $form->renderHiddenFields() ?>
      <div class="campos-left">
        <li><?php echo __('novedades_email') ?></li>
        <li><?php echo $form['mail']->render(array('tabIndex' => 1)) ?></li>
