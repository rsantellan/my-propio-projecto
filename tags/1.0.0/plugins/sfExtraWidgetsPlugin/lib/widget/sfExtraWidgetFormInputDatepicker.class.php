...
class sfExtraWidgetFormInputDatepicker extends sfWidgetFormInput
{
    ...
    {        
        ...
        $picker = '&nbsp;<img src="/sfExtraWidgetsPlugin/img/datepicker/datepicker_icon.png" align="absmiddle" id="' . $this->generateId($name) . '_icon" alt="" style="cursor:pointer;" onclick="dp_display(\'' . $this->generateId($name) . '\')" />';
