...
class  sfExtraWidgetFormInputDatepickerTime extends sfWidgetFormInput
{
    ...
    public function render($name, $value = null, $attributes = array(), $errors = array())
    {
        ...
        $response->addJavascript('/sfExtraWidgetsPlugin/js/datepicker.js');
        $response->addStylesheet('/sfExtraWidgetsPlugin/css/datepicker_' . $this->getOption('style') . '.css');
        
        $picker = '&nbsp;<img src="/sfExtraWidgetsPlugin/img/datepicker/datepicker_icon.png" align="absmiddle" id="' . $this->generateId($name . '[date]') . '_icon" alt="" style="cursor:pointer;" onclick="dp_display(\'' . $this->generateId($name . '[date]') . '\')" />';
