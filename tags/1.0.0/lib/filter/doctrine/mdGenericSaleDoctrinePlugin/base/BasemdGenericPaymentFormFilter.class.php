...
/**
 * mdGenericPayment filter form base class.
 *
 * @package    rentNchill
 * @subpackage filter
 ...
 */
abstract class BasemdGenericPaymentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('md_generic_payment_filters[%s]');
